...
dist/js/front.js: src/js/front.js
	$(BIN_DIR)/uglifyjs src/js/front.js -cm -o dist/js/front.js --source-map "root='../../',url='front.js.map',filename='front.js'"

dist/js/utils.js: src/js/utils.js
	$(BIN_DIR)/uglifyjs src/js/utils.js -cm -o dist/js/utils.js --source-map "root='../../',url='utils.js.map',filename='utils.js'"

dist/css/front.css: src/sass/front.scss
	$(BIN_DIR)/sass src/sass/front.scss dist/css/front.css
